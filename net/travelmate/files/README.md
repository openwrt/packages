...
To avoid these kind of deadlocks, travelmate will set all station interfaces in an "always off" mode and connects automatically to available/configured hotspots.  
