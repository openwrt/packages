...
###################################################
# f_envparse: parse adblock config, set environment
#
f_envparse()
{
    # function to read/set global options by callback, prepare list items and build option list for all others
    #
    config_cb()
    {
        local type="${1}"
