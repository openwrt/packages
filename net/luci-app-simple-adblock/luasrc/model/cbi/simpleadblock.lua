...
o2:value("0", "Suppress output")
o2:value("1", "Some output")
o2:value("2", "Verbose output")
o2.rmempty = false
o2.default = 2
...
o3:value("0", "Let local clients use their own DNS servers if set")
o3:value("1", "Force Router DNS server to all local devices")
o3.rmempty = false
o3.default = 1
...
d2 = s:option(DynamicList, "whitelist_url", translate("Whitelisted Domain URLs"), translate("URLs to lists of domains to be whitelisted"))
d2.addremove = true
d2.optional = true
...
d4 = s:option(DynamicList, "bad_domain", translate("Blacklisted Domain URLs"), translate("URLs to lists of domains to be blacklisted"))
d4.addremove = true
d4.optional = true

-- Blacklisted Hosts URLs
d5 = s:option(DynamicList, "bad_host", translate("Blacklisted Hosts URLs"), translate("URLs to lists of hosts to be blacklisted"))
d5.addremove = true
d5.optional = true
