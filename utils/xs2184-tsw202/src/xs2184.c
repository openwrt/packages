...
static void help()
{
	fprintf(stdout, "xs2184 version %i.%i.%i: View port status and switch control of a single port\n" \
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "d:u:m:Mcr:s:t:v")) != -1) {
		switch (c) {
		case 'c':
