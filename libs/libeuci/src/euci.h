...
/* Similar to euci_get_option(), but convert the returned string to int32 */
int euci_get_option_int32(const char *package, const char *section, const char *option, int *value);

/* Similar to euci_get_option(), but convert the returned string to uint32_t */
...
/* Similar to euci_get_first_option(), but convert the returned string to int32 */
int euci_get_first_option_int32(const char *package, const char *section, const char *option, int *value);

/* Similar to euci_get_first_option(), but convert the returned string to uint32_t */
...
/* Similar to euci_get_last_option(), but convert the returned string to int32 */
int euci_get_last_option_int32(const char *package, const char *section, const char *option, int *value);

/* Similar to euci_get_last_option(), but convert the returned string to uint32_t */
